...
constexpr const size_t UA_TYPES_intmax =
  std::numeric_limits<intmax_t>::digits == 63
  ? UA_TYPES_INT64
  : std::numeric_limits<intmax_t>::digits == 31
    ? UA_TYPES_INT32
    : UA_TYPES_INT16;
static_assert(
  (std::numeric_limits<intmax_t>::digits == 15)
...
constexpr const size_t UA_TYPES_uintmax =
  std::numeric_limits<uintmax_t>::digits == 64
  ? UA_TYPES_UINT64
  : std::numeric_limits<uintmax_t>::digits == 32
    ? UA_TYPES_UINT32
    : UA_TYPES_UINT16;
static_assert(
  (std::numeric_limits<uintmax_t>::digits == 16)
