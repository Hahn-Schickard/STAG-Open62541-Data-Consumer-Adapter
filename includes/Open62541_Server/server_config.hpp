...
HS_ServerConfig_setMinimal(UA_ServerConfig *config, UA_UInt16 portNumber,
                           const UA_ByteString *certificate) {
  return HS_ServerConfig_setMinimalCustomBuffer(config, portNumber, certificate,
                                                0, 0);
}
 ...
 * certificate. */
static UA_INLINE UA_StatusCode
HS_ServerConfig_setDefault(UA_ServerConfig *config) {
  return HS_ServerConfig_setMinimal(config, 4840, NULL);
}
