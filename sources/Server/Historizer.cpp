...
//               ColumnValue("Node_Id", toString(&node_id)), // column value is
//               automatically sanitized ColumnValue("Last_Updated",
//               getCurrentTimestamp())
//           }); // clang-format on
//       }
...
//       " " + to_string(calendar_time.hour) + ":" +
//       to_string(calendar_time.min) +
...
// void Historizer::dataChanged(UA_Server* server, UA_UInt32
// /*monitored_item_id*/,
//     void* /*monitored_item_context*/, const UA_NodeId* node_id,
//     void* /*node_context*/, UA_UInt32 attribute_id, const UA_DataValue*
//     value) {
//   if (db_) {
...
//     filter result.emplace_back(start_filter, "Source_Timestamp",
//     getTimestamp(start));
//   }
//   if (end > 0) {
...
//     string error_msg =
//         "Can not set historian bits for " +
...
//             columns,
//             ColumnFilter(FilterType::Greater, "Source_Timestamp", timestamp),
//             1, "Source_Timestamp", false);
...
//         // aggregate criteria, their indexes will never be in the results
//         maps,
