...
using AllConversions = ::testing::Types<
  ...
  IntegralConversion<intmax_t, int8_t,
    Information_Model::DataType::INTEGER, UA_TYPES_intmax, UA_TYPES_SBYTE,
    42, -1>,
  IntegralConversion<uintmax_t, uint8_t,
    Information_Model::DataType::UNSIGNED_INTEGER,
    UA_TYPES_uintmax, UA_TYPES_BYTE,
    13, 91>,
  IntegralConversion<intmax_t, int16_t,
    Information_Model::DataType::INTEGER, UA_TYPES_intmax, UA_TYPES_INT16,
    42, -1>,
  ...
  IntegralConversion<intmax_t, int32_t,
    Information_Model::DataType::INTEGER, UA_TYPES_intmax, UA_TYPES_INT32,
    42, -1>,
  IntegralConversion<uintmax_t, uint32_t,
    Information_Model::DataType::UNSIGNED_INTEGER,
    UA_TYPES_uintmax, UA_TYPES_UINT32,
    13, 91>,
  IntegralConversion<intmax_t, int64_t,
    Information_Model::DataType::INTEGER, UA_TYPES_intmax, UA_TYPES_INT64,
    42, -1>,
  IntegralConversion<uintmax_t, uint64_t,
    Information_Model::DataType::UNSIGNED_INTEGER,
    UA_TYPES_uintmax, UA_TYPES_UINT64,
    13, 91>,
  FloatConversion<float, UA_TYPES_FLOAT>,
  FloatConversion<double, UA_TYPES_DOUBLE>,
  IntegralConversion<uintmax_t, UA_StatusCode,
    Information_Model::DataType::UNSIGNED_INTEGER,
    UA_TYPES_uintmax, UA_TYPES_STATUSCODE,
