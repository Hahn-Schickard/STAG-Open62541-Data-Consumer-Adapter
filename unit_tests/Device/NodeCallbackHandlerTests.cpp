...
//     static constexpr size_t UA_READ_TYPE; // The respective index into
//     UA_TYPES using UA_Write_Type = ...;
//       // A possibly different type used by open62541 when writing
//     static constexpr size_t UA_WRITE_TYPE; // The respective index into
//     UA_TYPES static void UA_Write_Type_clear(UA_Write_Type*);

//     static IM_Type value2IM(Value_Type);

//     // The caller is responsible for calling `UA_Write_Type_clear` on the
//     result static UA_Write_Type value2Write(Value_Type);
...
//     UA_ByteString ret;
//     EXPECT_EQ(UA_STATUSCODE_GOOD, UA_ByteString_allocBuffer(&ret,
//     s.length())); memcpy(ret.data, s.data(), s.length()); return ret;
//   }
...
//     IntegralConversion<intmax_t, int8_t,
...
//     IntegralConversion<intmax_t, int16_t,
//     Information_Model::DataType::Integer,
//         // NOLINTNEXTLINE(readability-magic-numbers)
...
//     IntegralConversion<intmax_t, int32_t,
//     Information_Model::DataType::Integer,
//         // NOLINTNEXTLINE(readability-magic-numbers)
...
//     IntegralConversion<intmax_t, int64_t,
//     Information_Model::DataType::Integer,
//         // NOLINTNEXTLINE(readability-magic-numbers)
...
//     FloatConversion<double, UA_TYPES_DOUBLE>, StringConversion,
//     TimeConversion, ByteStringConversion>;
...
//   using IM_Type =
//   std::variant_alternative_t<static_cast<size_t>(Type::IM_TYPE),
//       Information_Model::DataVariant>;
...
//     EXPECT_EQ(
//         UA_STATUSCODE_GOOD, UA_NodeId_parse(&node2,
//         UA_STRING((char*)"i=13")));
//   }
...
//     return NodeCallbackHandler::readNodeValue(nullptr, nullptr, nullptr,
//     &node,
...
// // NOLINTNEXTLINE
// TYPED_TEST(NodeCallbackHandlerDataConversionTests,
// removeNonexistingCallbacks) {
//   EXPECT_EQ(UA_STATUSCODE_GOOD,
//       NodeCallbackHandler::addNodeCallbacks(
//           TestFixture::node1, TestFixture::read_only_callbacks));
